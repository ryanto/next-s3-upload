...
First, customize the Route Handler (App Router) or API Route (Pages Router) to use the access keys, bucket, region, and endpoint provided by your host. For example, a Digital Ocean Spaces setup may look something like this.
