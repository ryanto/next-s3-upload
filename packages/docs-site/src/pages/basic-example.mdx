...
The `<FileInput>` renders a hidden file input tag that coordinates uploading the file. This library gives you `<FileInput>` component because wiring up functions to open file inputs in React contains a good chunk of boilerplate code. Using this component will save you of time, but you're free to [use your own file input](/custom-file-input) if you'd like.
