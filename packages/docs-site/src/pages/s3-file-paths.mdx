...
By default this addon will give every upload a unique key in your S3 bucket. If you would like to customize the key you can do so by configuring the Route Handler (App Router) or API Route (Pages Router).
...
> We'll skip the Route Handler (App Router) example going forward.
> To apply the following examples to the Route Handler (App Router), refer to the code above.
